    ...
    <div className="min-h-screen bg-[#f7f3e7] font-gentium text-[#114c5f]">
      ...
      <main className="max-w-7xl mx-auto px-6 pt-16">
        ...
        <section className="py-28">
          ...
          <div className="grid md:grid-cols-3 gap-16 px-10">
            {[
              { n: "1", t: "Crea tu Perfil", d: "Registrate con tu correo institucional y define tus intereses" },
              { n: "2", t: "Publica y busca", d: "Di que habilidades ofrece(s)\nQue quieres aprender" },
              { n: "3", t: "Haz Match", d: "El sistema encontrara a alguien con disponibilidad horaria complatible para que empiezen el intercambio" }
            ].map((step) => (
              <div key={step.n} className="flex flex-col items-center text-left border-black}">
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-6xl font-black text-[#0057cc]">{step.n}</span>
                  <h3 className="text-2xl font-extrabold text-[#1a1a1a] ml-2 mt-1">{step.t}</h3>
                </div>
        ...
        <section className="pb-32">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {["Programacion", "Idiomas", "Musica", "Matematicas"].map((cat) => (
              <div key={cat} className="bg-[#eff6ff] border-2 border-[#0057cc]/30 py-6 rounded-xl text-center hover:bg-[#e0eeff] hover:border-[#0057cc] transition-all cursor-pointer shadow-sm">
      ...
      <footer className="bg-white/40 border-t border-[#9cd2d3]/30 py-16 text-center">
        <div className="max-w-2xl mx-auto px-4">
          <p className="text-[#4a4a4a] font-semibold mb-1">Comunidad 100% segura y verificada.</p>
          <p className="text-[#666] text-sm mb-12">Solo para la comunidad universitaria. Acceso valido por matricula</p>
