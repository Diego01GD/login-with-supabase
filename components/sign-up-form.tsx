  ...
  return (
    <div className="min-h-screen bg-[#f2e6cf] font-gentium flex flex-col items-center py-12 px-4">
      ...
      <div className="w-full max-w-5xl flex justify-between items-center mb-10">
        ...
        <Link
          href="/"
          className="text-[#114c5f] underline text-sm font-medium tracking-tight hover:opacity-80 transition-opacity"
        >
          &lt; volver al inicio
        </Link>
      </div>
      ...
      <div className="bg-white rounded-[2.5rem] p-12 shadow-lg w-full max-w-5xl border border-[#9cd2d3]/20">
        <h1 className="text-4xl font-extrabold text-center text-[#1a1a1a] mb-3">
        ...
        >
          ...
          <div className="space-y-2.5">
            ...
            <Input
              name="full_name"
              required
              className="bg-[#eff6ff] border-none rounded-2xl h-12 px-5 text-base"
            />
          </div>
          <div className="space-y-2.5">
            <Label
          ...
          <div className="space-y-2.5 relative">
            ...
            <select
              name="semester"
              required
              className="w-full bg-[#eff6ff] border-none rounded-2xl h-12 px-5 text-base text-gray-600 appearance-none cursor-pointer"
            >
          ...
          <div className="md:col-span-2 py-6">
            <Label className="text-[#4a4a4a] text-xs font-bold uppercase tracking-wider mb-5 block">
              ...
              {[
                ...
                <div key={int} className="flex items-center gap-3">
                  <input
                    ...
                    name="interests"
                    value={int}
                    className="w-5 h-5 border-[#9cd2d3] rounded shadow-sm accent-[#0057cc] cursor-pointer"
                  />
          ...
          <div className="md:col-span-2 space-y-2.5">
            ...
            <Input
              ...
              className="bg-[#eff6ff] border-none rounded-2xl h-12 px-5 text-base placeholder:text-gray-400"
            />
          </div>
          ...
          <div className="md:col-span-2 flex flex-col items-center gap-5 pt-10">
            {state?.error && (
              <p className="w-full max-w-md rounded-xl bg-red-50 px-4 py-3 text-sm font-medium text-red-700 border border-red-100">
                {state.error}
              </p>
            )}
            <Button
              type="submit"
              className="bg-[#0057cc] hover:bg-[#004bb3] w-full max-w-md h-14 rounded-2xl font-bold text-lg text-white shadow-lg shadow-[#0057cc]/20 transition-all"
            >
              Registrarse
            </Button>
